...
<div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[650px] h-[650px] bg-pink-100 rounded-full blur-[170px] opacity-20"></div>
      ...
      <nav className="sticky top-0 z-50 bg-white/70 backdrop-blur-xl/80 backdrop-blur-xl border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/dashboard"
              className="bg-white/70 backdrop-blur-xl text-black px-8 py-4 rounded-2xl font-bold hover:-translate-y-1 hover:scale-105 transition"
            >
              Get Started Free
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-8 pt-24 pb-16 grid lg:grid-cols-2 gap-16 items-center">
          {/* Left */}
  ...
  <h1 className="mt-8 text-6xl xl:text-7xl font-black leading-[1.05] tracking-tight">
    Build Your
  ...
  <div className="mt-10 flex flex-wrap gap-5">
    ...
    <Link
      href="/dashboard"
      className="px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 via-violet-600 to-purple-600 text-white font-bold shadow-xl hover:-translate-y-1 transition"
    >
      Create My Portfolio →
    </Link>
    ...
    <a
      href="#templates"
      className="px-8 py-4 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/40 shadow-lg font-semibold hover:-translate-y-1 transition"
    >
      Browse Templates
    </a>
  ...
  <div className="flex gap-12 mt-14">
    ...
    <div>
      <h2 className="text-4xl font-black text-blue-600">10K+</h2>
      <p className="text-gray-500 mt-2">Developers</p>
    </div>

    <div>
      <h2 className="text-4xl font-black text-violet-600">500+</h2>
      <p className="text-gray-500 mt-2">Portfolios</p>
    </div>

    <div>
      <h2 className="text-4xl font-black text-green-600">99%</h2>
      <p className="text-gray-500 mt-2">Recruiter Friendly</p>
         ...
         <div className="absolute top-12 -left-8 z-30 bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl px-5 py-4 border border-white/50">
...
<div className="absolute top-8 right-0 z-30 bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl px-5 py-4 border border-white/50">
           ...
           <div className="absolute bottom-20 -left-10 z-30 bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl px-5 py-4 border border-white/50">
          ...
          <div className="absolute bottom-2 right-2 z-30 bg-gradient-to-r from-blue-600 via-violet-600 to-purple-600 text-white rounded-2xl shadow-[0_20px_60px_rgba(99,102,241,.45)] px-6 py-4">
              <p className="text-xs opacity-80">Status</p>

              <p className="font-bold">Portfolio Live 🚀</p>
            </div>

            <div className="relative w-full max-w-[620px] h-[560px] mx-auto z-10 transition duration-500 hover:-translate-y-2">
...
>
        <div className="text-center">
         ...
         <h2 className="text-5xl lg:text-6xl font-black mt-3 leading-tight tracking-tight">
            Choose Your Portfolio Style
          </h2>

          <p className="text-gray-500 text-lg leading-8 mt-5 max-w-2xl mx-auto">
...
<div className="mt-10 space-y-5">
  ...
  <div className="flex items-center gap-3 text-lg">
    ✔ Dark / Light Mode
         ...
         <Link
  href="/dashboard"
  className={`mt-12 w-full flex justify-center items-center py-5 rounded-2xl text-white text-xl font-bold shadow-xl hover:scale-[1.03] transition-all duration-300 ${selectedTemplate.color}`}
>
  Use This Template 🚀
</Link>
...
<div className="max-w-7xl mx-auto px-8">
    <div className="h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent"></div>
     ...
     <section className="max-w-7xl mx-auto px-8 py-20">
        <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 text-white text-center py-24 px-10 shadow-2xl">
          ...
          <div className="flex justify-center gap-5 mt-12 flex-wrap">
            ...
            <Link
              href="/login"
              className="border border-white px-8 py-4 rounded-2xl font-bold hover:bg-white/70 backdrop-blur-xl hover:text-black transition"
            >
              Login
            </Link>
          </div>
  ...
  <div className="max-w-7xl mx-auto px-8 py-16 grid md:grid-cols-3 gap-12">
    ...
    {/* Left */}
    <div>
      <h2 className="text-4xl font-black">CodeFolio</h2>
